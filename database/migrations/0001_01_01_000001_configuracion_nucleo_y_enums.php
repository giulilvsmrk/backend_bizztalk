...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $enums = [
            ...
            'tipo_contacto' => "'whatsapp', 'fijo', 'movil', 'fax', 'atencion_cliente'",
        ];
    ...
    public function down(): void
    {
        ...
        $types = ['estado_pedido', 'canal_venta', 'rol_sucursal', 'tipo_entrega', 'tipo_descuento', 'alcance_promo', 'tipo_metodo_pago', 'estado_transaccion', 'proveedor_pago', 'tipo_contacto'];
